...
function SignupPage() {
    ...
    return (React.createElement(Box, { display: 'flex', flexDirection: 'column', width: '30%' },
        ...
        React.createElement(Dialog, { open: isDialogOpen, onClose: closeDialog },
            ...
            React.createElement(DialogActions, null, isSignupSuccess ? (React.createElement(Button, { component: Link, to: "/login" }, "Log in")) : (React.createElement(Button, { onClick: closeDialog }, "Done"))))));
}
