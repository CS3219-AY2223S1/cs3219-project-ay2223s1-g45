...
sequelize.sync();
export const addUserToQueue = (difficulty, socketId) => __awaiter(void 0, void 0, void 0, function* () {
...
export const findMatchingUserInQueue = (difficulty, socketId) => __awaiter(void 0, void 0, void 0, function* () {
    return queueingUser.findOne({
        where: { difficulty, [Op.not]: { socketId } }
    });
});
export const removeUserFromQueue = (socketId) => __awaiter(void 0, void 0, void 0, function* () {
